...
class Content(BaseModel):
    ...
    cast: Optional[str] = Field(default=None, description="Cast of short drama.")
    ...
    territory: Optional[str] = Field(default=None, description="Territory for publish of the content.")
